...
// cookies in the ith bag. You are also given an integer k that denotes the number of 
// children to distribute all the bags of cookies to. All the cookies in the same bag 
