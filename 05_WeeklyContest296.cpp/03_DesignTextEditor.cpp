...
// be moved beyond it. More formally, we have that 0 <= cursor.position <= 
...
// string cursorLeft(int k) Moves the cursor to the left k times. Returns 
// the last min(10, len) characters to the left of the cursor, where len is 
// the number of characters to the left of the cursor.
// string cursorRight(int k) Moves the cursor to the right k times. Returns 
// the last min(10, len) characters to the left of the cursor, where len is 
// the number of characters to the left of the cursor.
