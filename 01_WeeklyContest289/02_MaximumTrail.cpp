// problems/maximum-trailing-zeros-in-a-cornered-path/
...
// visited cell. After the turn, the path will then move exclusively in the alternate 
// direction: move vertically if it moved horizontally, and vice versa, also without 
