// 6040. Maximum Total Beauty of the Gardens
...
// already planted cannot be removed. You are then given another integer newFlowers, 
// which is the maximum number of flowers that Alice can additionally plant. 
